...
const Footer = () => {
  ...
  <nav>
    <h6 className="footer-title">Volunteer Category</h6> 
    <a className="link link-hover">Social service</a>
    <a className="link link-hover">Education</a>
    <a className="link link-hover">Healthcare</a>
    <a className="link link-hover">Animal welfare</a>
  </nav> 
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>IVolunteer. <br/>Reliable since 2010</p>
  </aside> 
